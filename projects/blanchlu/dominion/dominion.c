...
int Ambassador(int currentPlayer, int choice1, int choice2, struct gameState *state, int handPos){
		...
		for (j = 0; j < choice2; j++)
		{
				...
				trashCard(currentPlayer, state, state->hand[currentPlayer][choice1], 1);
		}			
		return 0;
}			
...
int Mine(int currentPlayer, int choice1, int choice2, struct gameState *state, int handPos){
		...
		trashCard(currentPlayer, state, j, 0);
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
		...
		switch( card ) 
		{
				...
				case mine:
						return Mine(currentPlayer, choice1, choice2, state, handPos);
				case remodel:
						j = state->hand[currentPlayer][choice1];  //store card we will trash
				...
				case baron:
						return Baron(currentPlayer, choice1, state);	
				case great_hall:
						//+1 Card
						drawCard(currentPlayer, state);
				...
				case minion:
						return Minion(currentPlayer, choice1, choice2, state, handPos);	
				case steward:
						if (choice1 == 1)
						{
								//+2 cards
				...
				case ambassador:
						return Ambassador(currentPlayer, choice1, choice2, state, handPos);	
				case cutpurse:
